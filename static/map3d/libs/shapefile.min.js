...
a.length-4)+".dbf",c).catch(function(){})),a=r(a,c)):a=a instanceof ArrayBuffer||a instanceof Uint8Array?l(a):t(a);return Promise.all([a,b]).then(function(a){var b=a[0];a=a[1];var d="utf-8";c&&null!=c.encoding&&(d=c.encoding);return T(b,a,a&&new TextDecoder(d))})}x.prototype.read=function(){var a=this._array;this._array=null;return Promise.resolve(a?{done:!1,value:a}:{done:!0,value:void 0})};x.prototype.cancel=function(){this._array=null;return Promise.resolve()};var P=function(a){return fetch(a).then(function(a){return a.body&&
...
function(a,b){"string"===typeof a?(/\.shp$/.test(a)||(a+=".shp"),a=r(a,b)):a=a instanceof ArrayBuffer||a instanceof Uint8Array?l(a):t(a);return Promise.resolve(a).then(O)};p.openDbf=function(a,b){var c="utf-8";b&&null!=b.encoding&&(c=b.encoding);c=new TextDecoder(c);"string"===typeof a?(/\.dbf$/.test(a)||(a+=".dbf"),a=r(a,b)):a=a instanceof ArrayBuffer||a instanceof Uint8Array?l(a):t(a);return Promise.resolve(a).then(function(a){return J(a,c)})};p.read=function(a,b,c){return I(a,b,c).then(function(a){var b=
